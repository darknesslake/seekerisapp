...
class ValorantScreen extends StatefulWidget {
  // final String userId;
  
  const ValorantScreen({super.key});

  @override
  ValorantScreenState createState() => ValorantScreenState();
}

class ValorantScreenState extends State<ValorantScreen> {
  // Map<String, dynamic>? _postData;
  
  @override
  Widget build(BuildContext context) {
    // final currentGame = Provider.of<Auth>(context).currentGame;
    const currentGame = 'VALORANT';
